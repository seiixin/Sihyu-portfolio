...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-24 bg-[#081208]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-8">
              ...
              {submitted ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-400">Thank you! We'll be in touch soon.</p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <label className="flex items-center gap-3 cursor-pointer select-none group">
                    ...
                    <input
                      ...
                      className="sr-only"
                    />
                    <span className="text-gray-400 text-sm">Yes, subscribe me to your newsletter</span>
                  </label>

                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full py-3 bg-lime-500 text-black font-bold rounded-lg hover:bg-lime-400 transition-colors disabled:opacity-60 disabled:cursor-not-allowed text-sm tracking-wider"
                  >
          ...
          <div className="lg:col-span-2 flex flex-col gap-4 justify-start">
            {[
              ...
              { icon: '📞', label: 'Phone', value: '0992 804 1384' },
              { icon: '✉️', label: 'Email', value: 'sihyusolutions.dev@gmail.com' },
            ].map((item) => (
              <div
                key={item.label}
            ...
            <div className="mt-4 p-5 rounded-xl bg-lime-500/10 border border-lime-500/30">
